...
#include <Engine/Render/Passes/LitGBuffer/LitGBufferCS.hpp>
#include <Engine/Render/Passes/LitGBuffer/LitGBufferPS.hpp>
#include <Engine/Render/Passes/GenerateShadowMaps/GenerateShadowMaps.hpp>
#include <Engine/Render/Passes/SkyBox/SkyAndFog.hpp>
#include <Engine/Render/Passes/Tonemap/LuminanceAvg.hpp>
#include <Engine/Render/Passes/Bloom/Bloom.hpp>
#include <Engine/Render/Passes/FinalPost/FinalPost.hpp>
#include <Engine/Render/Passes/MainZpass/MainZpass.hpp>
#include <Engine/Render/Passes/SpotlightSM/SpotlightSM.hpp>
#include <Engine/Render/Passes/SSAO/SSAO.hpp>
#include <Engine/Render/Passes/SSR/SSR.hpp>

#include <Engine/Settings/SettingsHolder.hpp>
