...
nk_d3d11_init(ID3D11Device *device, int width, int height, unsigned int max_vertex_buffer, unsigned int max_index_buffer)
{
	...
	//if (!vsName.empty())
	//{
	D3DX11CompileFromFile("Engine/UI/nuklear_d3d11.hlsl", NULL, NULL, "vs", "vs_5_0", 0, 0, NULL, &blob, &blobErr, NULL);
		//if (blobErr)
		//{
	...
	//if (!psName.empty())
	//{
		D3DX11CompileFromFile("Engine/UI/nuklear_d3d11.hlsl", NULL, NULL, "ps", "ps_5_0", 0, 0, NULL, &blob, &blobErr, NULL);
		//if (blobErr)
		//{
		//	std::string err = (char*)blobErr->GetBufferPointer();
		//	OutputDebugStringA(err.c_str());
